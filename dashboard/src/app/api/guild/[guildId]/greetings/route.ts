...
const FIELDS = [
  'welcomeChannel', 'farewellChannel', 'boosterChannel',
  'welcomeMessage', 'farewellMessage', 'boosterMessage',
  'welcomeEmbed', 'farewellEmbed', 'boosterEmbed',
  'welcomeEmbedTitle', 'welcomeEmbedFooter', 'welcomeEmbedThumbnail',
  'farewellEmbedTitle', 'farewellEmbedFooter', 'boosterEmbedTitle',
];
