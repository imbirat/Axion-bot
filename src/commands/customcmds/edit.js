...
module.exports = {
  ...
  description: 'Updates the response for an existing custom command',
  ...
  async prefixExecute(message, args, client) {
    try {
      if (args.length < 2) return message.reply('Usage: customcmd-edit <trigger> <new-response>');
